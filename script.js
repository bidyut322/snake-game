...
const changeFoodPosition = () => {
    //passing a random value between 0 -30
...
controls.forEach(key => {
    //calling changeDirection on each click and passing key dataset value as an object
...
const initGame = () => {
    ...
    //checking if snake's head is out of the wall, if so setting GameOver to true
